...
. Install http://www.oracle.com/technetwork/java/javase/downloads/java-archive-downloads-javase7-521261.html[Java 7], http://maven.apache.org/download.cgi[Maven], http://www.mulesoft.org/download-mule-esb-community-edition[Studio], and the Studio DevKit Plugin. See  xref:setting-up-your-dev-environment.adoc[Setting Up Your Development Environment].
...
. Import or re-import your Maven project to your IDE, as described in "Importing a Maven Project into Eclipse/Anypoint Studio" in xref:creating-an-anypoint-connector-project.adoc[Creating an Anypoint Connector Project].
