...
DevKit enforces JavaDoc documentation of your methods. One of the things you must add is an XML sample of the inputs required by each connector method. xref:annotation-reference.adoc[Learn more about Javadoc annotations for DevKit].
