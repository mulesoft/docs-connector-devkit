...
This document assumes you have already xref:creating-an-anypoint-connector-project.adoc[created a connector project] with at least some basic functionality, and are now ready to implement authentication on your connector.
