...
image::devkit-steps-operations.png["A flowchart showing the steps in a development process"]
...
image::dsimage.png["Dropdown menu of Entity Type"]
...
image::image2.png["DataMapper mapping window"]
...
image::image3.png["Dropdown menu of Entity Type"]

Also, the metadata about the entity can then be passed on to other Mule elements such as DataMapper or DataWeave (the Transform Message component).

image::image4.png["DataMapper mapping window"]
...
image::clear-datasense-metadata.png["Clear DataSense Metadata button"]
