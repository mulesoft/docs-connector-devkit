...
*GENERIC (Java)*. See xref:creating-a-connector-using-a-java-client-library.adoc[Creating a Connector using a Java Client Library]:
...
|*Authentication* |Click an authentication choice for how your connector accesses its resource: xref:basic-auth.adoc[Basic], xref:oauth-v1.adoc[OAuth V1], or xref:oauth-v2.adoc[OAuth V2].
...
|*Add DataSense Query Method* |Adds method for the DataSense Query Language. For more information, see xref:adding-datasense-query-language.adoc[Adding DataSense Query Language].
|===
