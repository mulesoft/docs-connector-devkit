...
image::connectorhelpinfo.png["Autocomplete function to help you create your connector project"]
...
image::screen23.png["Example of a code template for a field name"]
...
+
image::connector-install-update.png["Dropdown menu to install or update your connector"]
+
...
For example:
+
image::connector-display.png["Custom connector added to the list of connectors"]
...
image::import.jpg["Window that shows how to import an existing project"]
...
+
image::archivefile.png["Window for exporting resources to an archive file on the local file system"]

. Click the down arrow next to your project name and unclick *target*: +
+
image::archivedirs.png["Folder structure with the target folder unselected"]
