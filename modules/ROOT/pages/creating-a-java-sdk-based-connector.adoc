...
+
image::new-proj2.png["Dropdown menu showing how to create a new connector project"]
+
...
+
image::generictype.png["API type with the Generic option selected"]
...
+
image::creating-a-java-sdk-based-connector-71fef.png["Window for setting a connector icon"]
...
+
image::screen05.png["Example of generated project"]
...
image::screen18.png["Screen for searching and selecting a connector and adding it to the palette"]
...
image::screen11_1.png["Example of a configurable field"]
...
+
image::add-global-element.jpg["Screen that shows how to add a global element by clicking the green plus sign"]
+
...
+
image::devkitproperty.png["Screen that shows setting values for fields"]
...
image::myprocessor.png["Screen that shows how to configure a processor and how the processor looks in the UI after it is configured"]
...
image::content.png["The Content field with a String value specified"]
