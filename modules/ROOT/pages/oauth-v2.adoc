...
* xref:3.6@mule-runtime::http-transport-reference.adoc[HTTPS Transport Reference]
* xref:3.6@mule-runtime::tls-configuration.adoc#examples-for-https[HTTPS Examples]
