...
http://tools.ietf.org/html/rfc5849[OAuth 1.0 protocol/RFC-5849]. Also see xref:oauth-v1.adoc[OAuth V1].
...
* xref:3.7@mule-runtime::http-connector-reference.adoc[HTTPS Connector Reference]
* xref:3.7@mule-runtime::tls-configuration.adoc[HTTPS Examples]