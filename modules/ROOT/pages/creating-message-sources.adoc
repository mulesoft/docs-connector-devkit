...
In some cases it is necessary to create xref:3.2@mule-runtime::message-sources-and-message-processors.adoc#message-sources[Message Sources] instead of xref:3.2@mule-runtime::message-sources-and-message-processors.adoc#message-processors[Message Processors]. Basically, a Message Source receives or generates new messages to be processed by Mule.
...
* xref:3.2@mule-runtime::message-sources-and-message-processors.adoc#message-sources[Message Sources]
* xref:3.2@mule-runtime::message-sources-and-message-processors.adoc#message-processors[Message Processors]