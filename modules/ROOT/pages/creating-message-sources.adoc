...
In some cases it is necessary to create xref:3.3@mule-runtime::message-sources-and-message-processors.adoc[Message Sources] instead of xref:3.3@mule-runtime::message-sources-and-message-processors.adoc[Message Processors]. Basically, a Message Source receives or generates new messages to be processed by Mule.
...
For example the SalesForce Connector supports the SalesForce Streaming API in which users can subscribe to topics and receive notifications when a new event related to that topic happens.
...
* xref:3.3@mule-runtime::message-sources-and-message-processors.adoc[Message Processors]
* xref:3.3@mule-runtime::message-sources-and-message-processors.adoc[Message Sources]