...
* *NEXT*: Learn how to add xref:3.6@developing-devkit-connector-tests.adoc[tests] to your connector.
* Generate the xref:3.6@connector-reference-documentation.adoc[Reference Documentation].