...
* Familiarity with Anypoint Connectors, xref:studio::datasense.adoc[DataSense], xref:studio::datasense-query-editor.adoc[DataSense Query Editor], and this topic from a user level.
