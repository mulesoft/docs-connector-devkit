...
* *Main Java class*. Java code that you annotate with the `@Connector` attribute. See the http://mulesoft.github.io/mule-devkit/[Anypoint DevKit API Reference] for information about Anypoint Connector DevKit annotations.
