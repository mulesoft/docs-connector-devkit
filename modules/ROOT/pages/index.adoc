...
*xref:devkit-shortcut-to-success.adoc[Ready to Write Code?]*
...
* Begin at the beginning with the xref:anypoint-connector-concepts.adoc[Anypoint Connector Concepts].
* If you're eager to jump in and start writing code immediately, picking up the concepts as you go, begin with the xref:devkit-shortcut-to-success.adoc[DevKit Shortcut to Success].
