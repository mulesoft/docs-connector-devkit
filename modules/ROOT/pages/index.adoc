...
*Starting Tutorial*:  xref:tutorial-barn-connector.adoc[Tutorial - Barn Connector]
...
* Install https://www.mulesoft.com/studio[Anypoint Studio], http://www.oracle.com/technetwork/java/javase/downloads/index.html[Java version 8], xref:setting-up-your-dev-environment.adoc#SettingUpYourDevEnvironment-ApacheMaven[Apache Maven], and the xref:setting-up-your-dev-environment.adoc#installing-the-devkit-plugin-in-studio[Anypoint DevKit Plugin].
...
* If you are migrating a connector from Mule 3.5 to 3.6, see xref:release-notes::connector/connector-migration-guide-mule-3.5-to-3.6.adoc[Connector Migration Guide - Mule 3.5 to 3.6].

== Development Steps

. xref:setting-up-your-dev-environment.adoc[Set up your development environment] - Install Java JDK version 8, Apache Maven, Anypoint Studio, and Anypoint DevKit Plugin to build and test your connector. You can develop a connector using Windows, Mac, or Linux.
. _New Connector_ - xref:creating-an-anypoint-connector-project.adoc[Create an Anypoint project] - Set up Anypoint Studio and install the connector plugin.  +
...
. xref:defining-attributes-operations-and-data-model.adoc[Choose the connector's data model] - Models can be static Java objects or dynamic objects. You can use xref:3.6@mule-runtime::datasense.adoc[DataSense] - Determine what information the target resource expects.
...
|xref:anypoint-connector-development.adoc[Connector Development] |Provides steps to follow from set up to packaging a connector.
|xref:3.6@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors] |How to use and implement connectors - this section is in the Mule Runtime docs.
