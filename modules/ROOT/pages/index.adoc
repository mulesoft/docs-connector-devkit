...
DevKit is an annotations-based tool, with a wide set of available annotations to support its features. 
...
* *Main Java class*. Java code that you annotate with the `@Connector` attribute. See http://en.wikipedia.org/wiki/Java_annotation[Java annotations] for information about how annotations work.
