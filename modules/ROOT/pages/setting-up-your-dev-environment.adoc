...
If you have not already installed Anypoint Studio, follow the xref:3.6@mule-runtime::installing.adoc[detailed instructions] to install. For a quick introduction to Anypoint Studio, review xref:6.x@studio::index.adoc[Anypoint Studio Essentials].
