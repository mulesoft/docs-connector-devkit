...
+
image::installnewsoftware.png["Dropdown menu with the Install New Software option highlighted"]
+
...
+
image::devkit-update-site.png["Install window for Anypoint DevKit Update Site"]
+
