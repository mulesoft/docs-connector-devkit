...
If you have not already installed Anypoint Studio, follow the xref:3.5@mule-runtime::installing.adoc[detailed instructions] to install. For a quick introduction to Anypoint Studio, review xref:5.x@studio::basic-studio-tutorial.adoc[Anypoint Studio Essentials].
