...
This topic explains how to prepare a development environment that includes all the components required to develop Anypoint Connectors.
...
+
. In the Install menu's *Work with* drop-down menu, click the down arrow and click *Anypoint DevKit Update Site*. 
. Click the checkbox for Anypoint DevKit Plugin, and click *Next*.
+
image::devkit-update-site.png[]
+
