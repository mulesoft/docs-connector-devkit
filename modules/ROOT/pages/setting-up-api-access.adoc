...
** Consumer key
** Consumer secret
. For detailed instructions on creating an application on the Twitter platform, see xref:general:getting-started:anypoint-connector.adoc#obtaining-access-to-the-twitter-api[Configure Twitter for API Access].
