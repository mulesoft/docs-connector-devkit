...
image::configurable-screenshot.png["A dialog box for global element properties"]
...
image::defining-connector-attributes-5ea65.png["A configuration window with fields for connection details, including username, password, authorization URL, and proxy settings"]
...
image::friendlyname-screenshot-1.png["A list of connectors with friendly names"]
...
image::placement-1-screenshot.png["A global elements properties window on the General tab"]

image::placement-2-screenshot.png["A global elements properties window on the Advanced tab"]
