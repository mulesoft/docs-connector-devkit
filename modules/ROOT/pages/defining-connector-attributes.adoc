...
[NOTE]
The package https://www.mulesoft.org/docs/site/3.5.0/apidocs/org/mule/api/annotations/package-summary.html[org.mule.api.annotations.display] defines the annotations that let you perform these customizations.
