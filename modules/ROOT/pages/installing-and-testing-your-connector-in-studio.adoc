...
This command will create an update site that you can use to install the connector in Anypoint Studio. For more information about how to package your connector, check xref:packaging-your-connector-for-release.adoc[Packaging Your Connector for Release].

The *Install or Update* feature will also automatically install your connector in Anypoint Studio.

image::barn-studio-icon.png[]
