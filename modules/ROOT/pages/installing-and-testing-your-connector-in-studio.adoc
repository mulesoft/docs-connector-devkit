...
This command creates an update site that you can use to install the connector in Anypoint Studio. For more information about how to package your connector, check xref:packaging-your-connector-for-release.adoc[Packaging Your Connector for Release].
