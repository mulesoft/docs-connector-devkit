...
Value: `Community`
+
image::maven-last-wizard1.png[maven_last_wizard1]
...
* *NEXT:*  add a "sayHello" operation to your connector, then xref:installing-and-testing-your-connector.adoc[build it], install it in Studio, and test it in a flow.
* Learn more about the contents of your archetype- generated project by xref:examining-the-generated-connector-project.adoc[examining the results of your work].