...
In Mule 3.7 and newer, you can define the MIME type and encoding of a given return object from @Processor. See the xref:annotation-reference.adoc[Annotation Reference] for more information on annotations.
