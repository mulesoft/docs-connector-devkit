...
// == Testing Framework
// NOTE: This Github URL is not visible to non-ms employees
...
After you complete your test suite, you can xref:connector-reference-documentation.adoc[complete documentation and samples] for your connector.