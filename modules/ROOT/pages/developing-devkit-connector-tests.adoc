...
+
image::generatetests.png["A dropdown menu with the Generate Test options selected"]
+
...
+
image::testscaffoldinggeneration.png["A configuration window for test scaffolding generation"]
+
