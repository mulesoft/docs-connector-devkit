...
+
image::newconnproj.png["Dropdown menu showing how to create a new project"]
+
...
+
image::mavenconfiguration.png["Maven configuration window"]
+
. Select the connector project type you want to create. In this case, select *SOAP Connect*:
+
image::soapconnect.png["Window for creating a connector project with the SOAP Connect project type selected"]
+
. Specify the name of your connector and click *Add WSDL*:
+
image::connectorandwsdl.png["Window that shows the Add WSDL button"]
+
...
+
image::selectwsdllocation.png["Window for specifying the WSDL location"]
+
...
+
image::connectorinstallupdate.png["Dropdown menu to install or update your connector"]
+
...
+
image::sunsetriseconnector.png["Example flow of SunsetRise Connector"]
+
...
keyLabels: Names to be used as labels for the drop-downs shown in Studio.
...
image::wsdlsecurity.png["Window for specifying WSDL security and the connector icon"]
