...
The http://mulesoft.github.io/mule-salesforce-connector/[SalesForce Connector] supports the SalesForce Streaming API in which users can subscribe to topics and receive notifications when a new event related to that topic occurs.
...
* xref:3.7@mule-runtime::salesforce-connector.adoc[Salesforce Connector Documentation]
