...
Transformers convert message payloads to formats expected by their destinations. Mule Runtime provides many standard transformers, which you configure using predefined elements and attributes in your Mule XML configuration file but sometimes is useful to build custom transformers.
...
* xref:3.3@mule-runtime::using-transformers.adoc[Mule Transformers]