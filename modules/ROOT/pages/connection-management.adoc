...
|Defines the name that is going to be displayed in the connector configuration pop up. |Yes |
a|
*configElementName*

|Defines the name for the configuration that is going to be used in the Mule app. |No | config
|===
