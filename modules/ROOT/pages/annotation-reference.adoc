...
|*Newest Annotations* |<<AnnotationReference-configan,@Configuration>> <<AnnotationReference-connmgmtan,@ConnectionManagement>> <<AnnotationReference-connstratan,@ConnectionStrategy>> <<AnnotationReference-handlean,@Handle>> <<AnnotationReference-handleran,@Handler>> <<AnnotationReference-httpbasicauthan,@HTTPBasicAuth>> <<AnnotationReference-literalan,@Literal>> <<AnnotationReference-onexceptionan,@OnException>> <<AnnotationReference-reqentitlean,@RequiresEntitlement>> <<AnnotationReference-reqentlican,@RequiresEnterpriseLicense>>  <<AnnotationReference-testconnan,@TestConnectivity>>

|*General*
|<<AnnotationReference-catan,@Category>> <<AnnotationReference-confan,@Configurable>> <<AnnotationReference-connan,@Connector>> <<AnnotationReference-expran,@Expr>> <<AnnotationReference-expenan,@ExpressionEnricher>>
 <<AnnotationReference-exevan,@ExpressionEvaluator>> <<AnnotationReference-exlan,@ExpressionLanguage>> <<AnnotationReference-filan,@Filter>> <<AnnotationReference-iconan,@Icons>>
 <<AnnotationReference-ignan,@Ignore>> <<AnnotationReference-mimean,@Mime>> <<AnnotationReference-modulean,@Module>> <<AnnotationReference-pagean,@Paged>> <<AnnotationReference-procan,@Processor>>
 <<AnnotationReference-srcan,@Source>> <<AnnotationReference-tranan,@Transformer>> <<AnnotationReference-trsan,@TransformerResolver>>

|*Argument Passing* |<<AnnotationReference-inhean,@InboundHeaders>> <<AnnotationReference-ivhean,@InvocationHeaders>> <<AnnotationReference-literalan,@Literal>> <<AnnotationReference-outhan,@OutboundHeaders>>
 <<AnnotationReference-payan,@Payload>>   <<AnnotationReference-sessa,@SessionHeaders>>

|*Connection Management* |<<AnnotationReference-cnctan,@Connect>> <<AnnotationReference-coidan,@ConnectionIdentifier>> <<AnnotationReference-connmgmtan,@ConnectionManagement>>   <<AnnotationReference-connstratan,@ConnectionStrategy>> <<AnnotationReference-discan,@Disconnect>> <<AnnotationReference-invan,@InvalidateConnectionOn>> <<AnnotationReference-recan,@ReconnectOn>> <<AnnotationReference-valcan,@ValidateConnection>>

|*DataSense* |<<AnnotationReference-metan,@MetaDataCategory>> <<AnnotationReference-mtkpan,@MetaDataKeyParam>> <<AnnotationReference-mtkran,@MetaDataKeyRetriever>>
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>> <<AnnotationReference-mtran,@MetaDataRetriever>> <<AnnotationReference-mtsan,@MetaDataScope>>
 <<AnnotationReference-noman,@NoMetaData>> <<AnnotationReference-quan,@Query>> <<AnnotationReference-qupan,@QueryPart>> <<AnnotationReference-qutan,@QueryTranslator >>

|*Display*
|<<AnnotationReference-fnan,@FriendlyName>> <<AnnotationReference-passan,@Password>> <<AnnotationReference-pathan,@Path>> <<AnnotationReference-plcan,@Placement>> <<AnnotationReference-suman,@Summary>> <<AnnotationReference-textan,@Text>>

|*Exception Management*
|<<AnnotationReference-onexceptionan,@OnException>> <<AnnotationReference-handleran,@Handler>> <<AnnotationReference-handlean,@Handle>>

|*Lifecycle*
|<<AnnotationReference-displ,@Dispose>> <<AnnotationReference-initan,@Initialise>>   <<AnnotationReference-stan,@Start>> <<AnnotationReference-stopan,@Stop>>

|*Authentication* |<<AnnotationReference-httpbasicauthan,@HTTPBasicAuth>>

|*OAuth*
|<<AnnotationReference-oa1an,@OAuth>> <<AnnotationReference-oa2an,@OAuth2>> <<AnnotationReference-oatan,@OAuthAccessToken>> <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>> <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>
 <<AnnotationReference-oacban,@OAuthCallbackParameter>> <<AnnotationReference-oackan,@OAuthConsumerKey>> <<AnnotationReference-oacsan,@OAuthConsumerSecret>>
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>> <<AnnotationReference-oapan,@OAuthPostAuthorization>>
 <<AnnotationReference-oapran,@OAuthProtected>> <<AnnotationReference-oasan,@OAuthScope>>

|*Parameters* |<<AnnotationReference-conkan,@ConnectionKey>> <<AnnotationReference-defan,@Default>> <<AnnotationReference-eman,@Email>> <<AnnotationReference-e,@ExceptionPayload>>
 <<AnnotationReference-mtskan,@MetaDataStaticKey>> <<AnnotationReference-optan,@Optional>>   <<AnnotationReference-refan,@RefOnly>>

|*REST*
|<<AnnotationReference-binpan,@BinaryParam>> <<AnnotationReference-rstcan,@RestCall>> <<AnnotationReference-rstean,@RestExceptionOn>> <<AnnotationReference-rstpan,@RestHeaderParam>>
 <<AnnotationReference-rshcan,@RestHttpClient>> <<AnnotationReference-rsppan,@RestPostParam>> <<AnnotationReference-rsqpan,@RestQueryParam>> <<AnnotationReference-rstoan,@RestTimeout>>
 <<AnnotationReference-rsupan,@RestUriParam>>
|===
...
See also: <<AnnotationReference-rstcan,@RestCall>> <<AnnotationReference-rstean,@RestExceptionOn>> <<AnnotationReference-rstpan,@RestHeaderParam>> <<AnnotationReference-rshcan,@RestHttpClient>>
 <<AnnotationReference-rsppan,@RestPostParam>> <<AnnotationReference-rsqpan,@RestQueryParam>> <<AnnotationReference-rstoan,@RestTimeout>> <<AnnotationReference-rsupan,@RestUriParam>>
...
See also: <<AnnotationReference-confan,@Configurable>> <<AnnotationReference-connan,@Connector>> <<AnnotationReference-expran,@Expr>> <<AnnotationReference-expenan,@ExpressionEnricher>> <<AnnotationReference-exevan,@ExpressionEvaluator>>
 <<AnnotationReference-exlan,@ExpressionLanguage>> <<AnnotationReference-filan,@Filter>> <<AnnotationReference-iconan,@Icons>> <<AnnotationReference-ignan,@Ignore>> <<AnnotationReference-mimean,@Mime>> <<AnnotationReference-modulean,@Module>> <<AnnotationReference-pagean,@Paged>> <<AnnotationReference-procan,@Processor>>
 <<AnnotationReference-srcan,@Source>> <<AnnotationReference-tranan,@Transformer>> <<AnnotationReference-trsan,@TransformerResolver>>
...
See also: <<AnnotationReference-catan,@Category>>   <<AnnotationReference-connan,@Connector>>   <<AnnotationReference-expran,@Expr>>   <<AnnotationReference-expenan,@ExpressionEnricher>>   <<AnnotationReference-exevan,@ExpressionEvaluator>>   +
 <<AnnotationReference-exlan,@ExpressionLanguage>>   <<AnnotationReference-filan,@Filter>>   <<AnnotationReference-iconan,@Icons>>   <<AnnotationReference-ignan,@Ignore>>   <<AnnotationReference-mimean,@Mime>>   <<AnnotationReference-modulean,@Module>>   <<AnnotationReference-pagean,@Paged>>   <<AnnotationReference-procan,@Processor>> +
 <<AnnotationReference-srcan,@Source>>   <<AnnotationReference-tranan,@Transformer>>   <<AnnotationReference-trsan,@TransformerResolver>>
...
Using this annotation, a connector or module can configure different parameters at a global element level using <<AnnotationReference-confan,@Configurable>> when there is no need for authentication and/or connection management.
...
See also: <<AnnotationReference-confan,@Configurable>> <<AnnotationReference-cnctan,@Connect>>   <<AnnotationReference-coidan,@ConnectionIdentifier>>   <<AnnotationReference-connmgmtan,@ConnectionManagement>>   <<AnnotationReference-connstratan,@ConnectionStrategy>>   <<AnnotationReference-discan,@Disconnect>> <<AnnotationReference-invan,@InvalidateConnectionOn>>   <<AnnotationReference-recan,@ReconnectOn>>   <<AnnotationReference-valcan,@ValidateConnection>>
...
See also: xref:connection-management.adoc[Connection Management]  <<AnnotationReference-cnctan,@Connect>>  <<AnnotationReference-coidan,@ConnectionIdentifier>>  <<AnnotationReference-discan,@Disconnect>>  <<AnnotationReference-invan,@InvalidateConnectionOn>>  +
 <<AnnotationReference-recan,@ReconnectOn>>  <<AnnotationReference-valcan,@ValidateConnection>>
...
Marks a method inside a <<AnnotationReference-connan,@Connector>>  as responsible for identifying the connection.
...
See also:  xref:connection-management.adoc[Connection Management]   <<AnnotationReference-cnctan,@Connect>>   <<AnnotationReference-discan,@Disconnect>>   <<AnnotationReference-invan,@InvalidateConnectionOn>>   +
 <<AnnotationReference-recan,@ReconnectOn>>   <<AnnotationReference-valcan,@ValidateConnection>>
...
Marks a parameter inside the connect method as part of the key for the connector lookup. This only can be used as part of the <<AnnotationReference-cnctan,@Connect>> method.
...
See also: <<AnnotationReference-defan,@Default>>  <<AnnotationReference-eman,@Email>>  <<AnnotationReference-excpan,@ExceptionPayload>>  <<AnnotationReference-mtskan,@MetaDataStaticKey>>  <<AnnotationReference-optan,@Optional>>  <<AnnotationReference-refan,@RefOnly>>
...
Indicates a connector strategy class. See <<AnnotationReference-connstrat,@ConnectionStrategy>> for more examples.

See also: <<AnnotationReference-configan,@Configuration>> <<AnnotationReference-confan,@Configurable>> <<AnnotationReference-cnctan,@Connect>> <<AnnotationReference-coidan,@ConnectionIdentifier>>  +
 <<AnnotationReference-connstratan,@ConnectionStrategy>> <<AnnotationReference-discan,@Disconnect>> <<AnnotationReference-invan,@InvalidateConnectionOn>> <<AnnotationReference-recan,@ReconnectOn>>  +
 <<AnnotationReference-testconnan,@TestConnectivity>>   <<AnnotationReference-valcan,@ValidateConnection>>
...
See also: <<AnnotationReference-connan,@Connector>> <<AnnotationReference-confan,@Configurable>> <<AnnotationReference-cnctan,@Connect>> <<AnnotationReference-coidan,@ConnectionIdentifier>> <<AnnotationReference-connmgmtan,@ConnectionManagement>> <<AnnotationReference-discan,@Disconnect>> <<AnnotationReference-invan,@InvalidateConnectionOn>> <<AnnotationReference-recan,@ReconnectOn>> <<AnnotationReference-valcan,@ValidateConnection>>
...
See also: <<AnnotationReference-catan,@Category>>  <<AnnotationReference-confan,@Configurable>>  <<AnnotationReference-expran,@Expr>>  <<AnnotationReference-expenan,@ExpressionEnricher>>  <<AnnotationReference-exevan,@ExpressionEvaluator>>   +
 <<AnnotationReference-exlan,@ExpressionLanguage>>  <<AnnotationReference-filan,@Filter>>  <<AnnotationReference-iconan,@Icons>>  <<AnnotationReference-ignan,@Ignore>>  <<AnnotationReference-mimean,@Mime>>  <<AnnotationReference-modulean,@Module>>  <<AnnotationReference-pagean,@Paged>>  <<AnnotationReference-procan,@Processor>>   +
  <<AnnotationReference-srcan,@Source>>  <<AnnotationReference-tranan,@Transformer>>  <<AnnotationReference-trsan,@TransformerResolver>>
...
See also:  <<AnnotationReference-conkan,@ConnectionKey>>  <<AnnotationReference-eman,@Email>> <<AnnotationReference-excpan,@ExceptionPayload>> <<AnnotationReference-mtskan,@MetaDataStaticKey>>

<<AnnotationReference-optan,@Optional>> <<AnnotationReference-refan,@RefOnly>>
...
See also:  xref:connection-management.adoc[Connection Management]   <<AnnotationReference-cnctan,@Connect>>   <<AnnotationReference-coidan,@ConnectionIdentifier>>   <<AnnotationReference-invan,@InvalidateConnectionOn>>   +
 <<AnnotationReference-recan,@ReconnectOn>>   <<AnnotationReference-valcan,@ValidateConnection>>
...
See also: <<AnnotationReference-initan,@Initialise>>   <<AnnotationReference-stan,@Start>>   <<AnnotationReference-stopan,@Stop>>
...
See also:  <<AnnotationReference-conkan,@ConnectionKey>>  <<AnnotationReference-defan,@Default>>   <<AnnotationReference-excpan,@ExceptionPayload>>   <<AnnotationReference-mtskan,@MetaDataStaticKey>>   <<AnnotationReference-optan,@Optional>>   <<AnnotationReference-refan,@RefOnly>>
...
See also:  <<AnnotationReference-conkan,@ConnectionKey>>    <<AnnotationReference-defan,@Default>>  <<AnnotationReference-eman,@Email>>   <<AnnotationReference-mtskan,@MetaDataStaticKey>>   <<AnnotationReference-optan,@Optional>>   <<AnnotationReference-refan,@RefOnly>>
...
Binds a parameter in a <<AnnotationReference-procan,@Processor>> method to an expression.

Binding a parameter to an expression works similar to <<AnnotationReference-payan,@Payload>>  in the sense that the user of the module won't be able to alter the expression or the value of the parameter from the XML. A binding is hardcoded and the user cannot change it.
...
See also:  <<AnnotationReference-catan,@Category>>   <<AnnotationReference-confan,@Configurable>>   <<AnnotationReference-connan,@Connector>>   <<AnnotationReference-expenan,@ExpressionEnricher>>   <<AnnotationReference-exevan,@ExpressionEvaluator>>   +
 <<AnnotationReference-exlan,@ExpressionLanguage>>   <<AnnotationReference-filan,@Filter>>   <<AnnotationReference-iconan,@Icons>>   <<AnnotationReference-ignan,@Ignore>>   <<AnnotationReference-mimean,@Mime>>   <<AnnotationReference-modulean,@Module>>   <<AnnotationReference-pagean,@Paged>>   <<AnnotationReference-procan,@Processor>>   +
 <<AnnotationReference-srcan,@Source>>   <<AnnotationReference-tranan,@Transformer>>   <<AnnotationReference-trsan,@TransformerResolver>>
...
Marks a method inside an <<AnnotationReference-exlan,@ExpressionLanguage>>  as the responsible for enriching mule messages based on an expression.
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>    <<AnnotationReference-expran,@Expr>>    <<AnnotationReference-exevan,@ExpressionEvaluator>>   +
 <<AnnotationReference-exlan,@ExpressionLanguage>>    <<AnnotationReference-filan,@Filter>>    <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-ignan,@Ignore>>    <<AnnotationReference-mimean,@Mime>>    <<AnnotationReference-modulean,@Module>>    <<AnnotationReference-pagean,@Paged>>   +
 <<AnnotationReference-procan,@Processor>> <<AnnotationReference-srcan,@Source>>   <<AnnotationReference-tranan,@Transformer>>   <<AnnotationReference-trsan,@TransformerResolver>>
...
Marks a method inside an <<AnnotationReference-exlan,@ExpressionLanguage>> annotation as being responsible for evaluating expressions.
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>    <<AnnotationReference-expran,@Expr>>    <<AnnotationReference-expenan,@ExpressionEnricher>>   +
 <<AnnotationReference-exlan,@ExpressionLanguage>>    <<AnnotationReference-filan,@Filter>>    <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-ignan,@Ignore>>    <<AnnotationReference-mimean,@Mime>>    <<AnnotationReference-modulean,@Module>>    <<AnnotationReference-pagean,@Paged>>    +
 <<AnnotationReference-procan,@Processor>>    <<AnnotationReference-srcan,@Source>>    <<AnnotationReference-tranan,@Transformer>>    <<AnnotationReference-trsan,@TransformerResolver>>
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>   <<AnnotationReference-expran,@Expr>>    <<AnnotationReference-expenan,@ExpressionEnricher>>   +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>    <<AnnotationReference-filan,@Filter>>    <<AnnotationReference-iconan,@Icons>>   <<AnnotationReference-ignan,@Ignore>>    <<AnnotationReference-mimean,@Mime>>   <<AnnotationReference-modulean,@Module>>    <<AnnotationReference-pagean,@Paged>>    +
 <<AnnotationReference-procan,@Processor>> <<AnnotationReference-srcan,@Source>>    <<AnnotationReference-tranan,@Transformer>>    <<AnnotationReference-trsan,@TransformerResolver>>
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>    <<AnnotationReference-expran,@Expr>>   <<AnnotationReference-expenan,@ExpressionEnricher>>    +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>    <<AnnotationReference-exlan,@ExpressionLanguage>>    <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-ignan,@Ignore>>   <<AnnotationReference-mimean,@Mime>>    +
 <<AnnotationReference-modulean,@Module>>    <<AnnotationReference-pagean,@Paged>>    <<AnnotationReference-procan,@Processor>>  <<AnnotationReference-srcan,@Source>>   <<AnnotationReference-tranan,@Transformer>>    <<AnnotationReference-trsan,@TransformerResolver>>
...
Use this annotation to instance variables and method parameters to provide a way to override the default inferred nickname for a <<AnnotationReference-confan,@Configurable>> variable or a <<AnnotationReference-procan,@Processor>>, <<AnnotationReference-srcan,@Source>>, <<AnnotationReference-tranan,@Transformer>> method parameter. Provide a parameter if annotated with this.
...
See also: <<AnnotationReference-passan,@Password>>   <<AnnotationReference-pathan,@Path>>   <<AnnotationReference-plcan,@Placement>>   <<AnnotationReference-suman,@Summary>>   <<AnnotationReference-textan,@Text>>
...
Use with <<AnnotationReference-handleran,@Handler>>:
...
* RECONNECT - Retry the operation if the @Processor has <<AnnotationReference-recan,@ReconnectOn>>, and the @Handle throws an exception of that kind.
* FAIL - Fail the operation by throwing an exception that does not belongs to the <<AnnotationReference-recan,@ReconnectOn>>, or the processors don't support reconnection.
...
See also: <<AnnotationReference-onexceptionan,@OnException>>     <<AnnotationReference-handleran,@Handler>>
...
Indicates a class that handles an exception. Use with <<AnnotationReference-onexceptionan,@OnException>>  and  <<AnnotationReference-handlean,@Handle>>.
...
See also: <<AnnotationReference-onexceptionan,@OnException>> <<AnnotationReference-handlean,@Handle>>
...
See also: <<AnnotationReference-rstcan,@RestCall>>  <<AnnotationReference-oa2an,@OAuth2>> <<AnnotationReference-oatan,@OAuthAccessToken>> <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>

<<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>    +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>    +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>    +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>  <<AnnotationReference-httpbasicauthan,@HTTPBasicAuth>>
...
See also:  <<AnnotationReference-catan,@Category>>  <<AnnotationReference-confan,@Configurable>>  <<AnnotationReference-connan,@Connector>>  <<AnnotationReference-expran,@Expr>>  <<AnnotationReference-expenan,@ExpressionEnricher>>   +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>  <<AnnotationReference-exlan,@ExpressionLanguage>>  <<AnnotationReference-filan,@Filter>>   <<AnnotationReference-ignan,@Ignore>>  <<AnnotationReference-mimean,@Mime>>    <<AnnotationReference-modulean,@Module>>    +
 <<AnnotationReference-pagean,@Paged>>  <<AnnotationReference-procan,@Processor>>   <<AnnotationReference-srcan,@Source>>  <<AnnotationReference-tranan,@Transformer>>  <<AnnotationReference-trsan,@TransformerResolver>>
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>    <<AnnotationReference-expran,@Expr>>    <<AnnotationReference-expenan,@ExpressionEnricher>>   +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>    <<AnnotationReference-exlan,@ExpressionLanguage>>    <<AnnotationReference-filan,@Filter>>    <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-mimean,@Mime>>    <<AnnotationReference-modulean,@Module>>    +
 <<AnnotationReference-pagean,@Paged>>    <<AnnotationReference-procan,@Processor>>  <<AnnotationReference-srcan,@Source>>    <<AnnotationReference-tranan,@Transformer>>    <<AnnotationReference-trsan,@TransformerResolver>>
...
See also: <<AnnotationReference-ivhean,@InvocationHeaders>>   <<AnnotationReference-outhan,@OutboundHeaders>>  <<AnnotationReference-payan,@Payload>>  <<AnnotationReference-sessa,@SessionHeaders>>
...
See also: <<AnnotationReference-displ,@Dispose>>   <<AnnotationReference-stan,@Start>>   <<AnnotationReference-stopan,@Stop>>
...
Used on a method to catch Exceptions - deprecated use <<AnnotationReference-recan,@ReconnectOn>> instead.
...
See also:  xref:connection-management.adoc[Connection Management]   <<AnnotationReference-cnctan,@Connect>>    <<AnnotationReference-coidan,@ConnectionIdentifier>>    <<AnnotationReference-discan,@Disconnect>>    +
 <<AnnotationReference-recan,@ReconnectOn>>   <<AnnotationReference-valcan,@ValidateConnection>>
...
See also: <<AnnotationReference-inhean,@InboundHeaders>>    <<AnnotationReference-outhan,@OutboundHeaders>>  <<AnnotationReference-payan,@Payload>>  <<AnnotationReference-sessa,@SessionHeaders>>
...
Specifies xref:3.6@mule-runtime::mule-expression-language-mel.adoc[Mule Expression Language (MEL)] as a method parameter without the DevKit resolving the expression. You can use any MEL code with this annotation.
...
See also: <<AnnotationReference-inhean,@InboundHeaders>>   <<AnnotationReference-ivhean,@InvocationHeaders>>     <<AnnotationReference-outhan,@OutboundHeaders>> <<AnnotationReference-payan,@Payload>>  <<AnnotationReference-sessa,@SessionHeaders>>
...
See also: <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> +
 <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator >>
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> +
 <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator >>
...
Use this annotation inside an @Connector context or inside an <<AnnotationReference-metan,@MetaDataCategory>>.
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> +
 <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator >>
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator>>
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator >>
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   +
 <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator >>
...
Defines the specific MetaData type of the annotated value. When applied to a <<AnnotationReference-procan,@Processor>> it affects (by default) just the Output, otherwise it affects the field parameter.
...
See also:  <<AnnotationReference-conkan,@ConnectionKey,>>    <<AnnotationReference-defan,@Default,>> <<AnnotationReference-eman,@Email>>, <<AnnotationReference-excpan,@ExceptionPayload>>,   <<AnnotationReference-optan,@Optional>> ,  <<AnnotationReference-refan,@RefOnly>>
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>   <<AnnotationReference-expran,@Expr>>    <<AnnotationReference-expenan,@ExpressionEnricher>>    +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>    <<AnnotationReference-exlan,@ExpressionLanguage>>    <<AnnotationReference-filan,@Filter>>    <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-ignan,@Ignore>>   +
 <<AnnotationReference-modulean,@Module>>    <<AnnotationReference-pagean,@Paged>>    <<AnnotationReference-procan,@Processor>>  <<AnnotationReference-srcan,@Source>>    <<AnnotationReference-tranan,@Transformer>>   <<AnnotationReference-trsan,@TransformerResolver>>
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>   <<AnnotationReference-expran,@Expr>>   <<AnnotationReference-expenan,@ExpressionEnricher>>    +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>   <<AnnotationReference-exlan,@ExpressionLanguage>>  <<AnnotationReference-filan,@Filter>>   <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-ignan,@Ignore>>   <<AnnotationReference-mimean,@Mime>>   +
 <<AnnotationReference-pagean,@Paged>>   <<AnnotationReference-procan,@Processor>>   <<AnnotationReference-srcan,@Source>>    <<AnnotationReference-tranan,@Transformer>>   <<AnnotationReference-trsan,@TransformerResolver>>
...
Marks a <<AnnotationReference-procan,@Processor>> to avoid discovering metadata with @MetaDataRetriever and @MetaDataKeyRetriever mechanism.

See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> +
 <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator >>
...
See also: <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
Holds an access token. When an <<AnnotationReference-procan,@Processor>> method is invoked, an OAuth access token is set in case the Resource Owner already authorized the Consumer; otherwise the method isn't invoked and the Resource Owner is redirected to the OAuth or OAuth2 authorization URL depending on the class level annotation used.

*Note*: This annotation is only supported for class fields.

A class annotated with <<AnnotationReference-oa1an,@OAuth>> or <<AnnotationReference-oa2an,@OAuth2>> needs to have exactly one field annotated with @OAuthAccessToken.
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>> <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   +
 <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   +
 <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>> <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   +
 <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>> <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   +
 <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>> <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   +
 <<AnnotationReference-oapan,@OAuthPostAuthorization>>   <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>     +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oapan,@OAuthPostAuthorization>> <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>  <<AnnotationReference-httpbasicauthan,@HTTPBasicAuth>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>> <<AnnotationReference-oapran,@OAuthProtected>>   <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 ...
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   +
 <<AnnotationReference-oasan,@OAuthScope>>
...
See also: <<AnnotationReference-oa1an,@OAuth>>   <<AnnotationReference-oa2an,@OAuth2>>   <<AnnotationReference-oatan,@OAuthAccessToken>>   <<AnnotationReference-oatian,@OAuthAccessTokenIdentifier>>   +
 <<AnnotationReference-oatsan,@OAuthAccessTokenSecret>>   <<AnnotationReference-oaupan,@OAuthAuthorizationParameter>>   +
 <<AnnotationReference-oacban,@OAuthCallbackParameter>>   <<AnnotationReference-oackan,@OAuthConsumerKey>>   <<AnnotationReference-oacsan,@OAuthConsumerSecret>>   +
 <<AnnotationReference-oaitan,@OAuthInvalidateAccessTokenOn>>   <<AnnotationReference-oapan,@OAuthPostAuthorization>>   <<AnnotationReference-oapran,@OAuthProtected>>
...
See also: <<AnnotationReference-handlean,@Handle>>     <<AnnotationReference-handleran,@Handler>>
...
See also:  <<AnnotationReference-conkan,@ConnectionKey>>   <<AnnotationReference-defan,@Default>>  <<AnnotationReference-eman,@Email>> <<AnnotationReference-excpan,@ExceptionPayload>>
<<AnnotationReference-mtskan,@MetaDataStaticKey>>   <<AnnotationReference-refan,@RefOnly>>
...
See also: <<AnnotationReference-inhean,@InboundHeaders>>   <<AnnotationReference-ivhean,@InvocationHeaders>>  <<AnnotationReference-payan,@Payload>> <<AnnotationReference-sessa,@SessionHeaders>>
...
Marks a method inside a <<AnnotationReference-connan,@Connector>> as an operation that returns a paged result set. Methods annotated with this interface must also be annotated with <<AnnotationReference-procan,@Processor>> and must return an instance of @ProviderAwarePagingDelegate.
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>    <<AnnotationReference-expran,@Expr>>   <<AnnotationReference-expenan,@ExpressionEnricher>>    +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>   <<AnnotationReference-exlan,@ExpressionLanguage>>    <<AnnotationReference-filan,@Filter>>   <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-ignan,@Ignore>>   <<AnnotationReference-mimean,@Mime>>    +
 <<AnnotationReference-modulean,@Module>>    <<AnnotationReference-procan,@Processor>>  <<AnnotationReference-srcan,@Source>>    <<AnnotationReference-tranan,@Transformer>>   <<AnnotationReference-trsan,@TransformerResolver>>
...
See also: <<AnnotationReference-fnan,@FriendlyName>>   <<AnnotationReference-pathan,@Path>>   <<AnnotationReference-plcan,@Placement>>   <<AnnotationReference-suman,@Summary>>   <<AnnotationReference-textan,@Text>>
...
See also: <<AnnotationReference-fnan,@FriendlyName>>   <<AnnotationReference-passan,@Password>>   <<AnnotationReference-plcan,@Placement>>   <<AnnotationReference-suman,@Summary>>   <<AnnotationReference-textan,@Text>>
...
See also: <<AnnotationReference-inhean,@InboundHeaders>>    <<AnnotationReference-ivhean,@InvocationHeaders>>    <<AnnotationReference-outhan,@OutboundHeaders>>  <<AnnotationReference-sessa,@SessionHeaders>>
...
See also: <<AnnotationReference-fnan,@FriendlyName>>   <<AnnotationReference-passan,@Password>>   <<AnnotationReference-pathan,@Path>>   <<AnnotationReference-suman,@Summary>>   <<AnnotationReference-textan,@Text>>
...
See also:  <<AnnotationReference-catan,@Category>>    <<AnnotationReference-confan,@Configurable>>   <<AnnotationReference-connan,@Connector>>   <<AnnotationReference-expran,@Expr>>    <<AnnotationReference-expenan,@ExpressionEnricher>>   +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>    <<AnnotationReference-exlan,@ExpressionLanguage>>    <<AnnotationReference-filan,@Filter>>    <<AnnotationReference-iconan,@Icons>>   <<AnnotationReference-ignan,@Ignore>>   <<AnnotationReference-mimean,@Mime>>    +
 <<AnnotationReference-modulean,@Module>>    <<AnnotationReference-pagean,@Paged>>   <<AnnotationReference-srcan,@Source>>   <<AnnotationReference-tranan,@Transformer>>    <<AnnotationReference-trsan,@TransformerResolver>>
...
Supports easy query building by using DataSense Query Language (DSQL). Define @Query within an <<AnnotationReference-connan,@Connector>> scope.
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> +
 <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-qupan,@QueryPart>>   <<AnnotationReference-qutan,@QueryTranslator>>
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> +
 <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qutan,@QueryTranslator >>
...
See also: <<AnnotationReference-metan,@MetaDataCategory>>   <<AnnotationReference-mtkpan,@MetaDataKeyParam>>   <<AnnotationReference-mtkran,@MetaDataKeyRetriever>> +
 <<AnnotationReference-mtoran,@MetaDataOutputRetriever>>   <<AnnotationReference-mtran,@MetaDataRetriever>>   <<AnnotationReference-mtsan,@MetaDataScope>> +
 <<AnnotationReference-noman,@NoMetaData>>   <<AnnotationReference-quan,@Query>>   <<AnnotationReference-qupan,@QueryPart>>
...
See also:  xref:connection-management.adoc[Connection Management]  <<AnnotationReference-cnctan,@Connect>>   <<AnnotationReference-coidan,@ConnectionIdentifier>>  <<AnnotationReference-discan,@Disconnect>>    +
 <<AnnotationReference-invan,@InvalidateConnectionOn>>  <<AnnotationReference-valcan,@ValidateConnection>>
...
Marks a <<AnnotationReference-confan,@Configurable>> field, a <<AnnotationReference-procan,@Processor>> parameter, or <<AnnotationReference-srcan,@Source>> parameter as being passed by reference only.

See also:  <<AnnotationReference-conkan,@ConnectionKey>>   <<AnnotationReference-defan,@Default>>  <<AnnotationReference-eman,@Email>>  <<AnnotationReference-excpan,@ExceptionPayload>>   <<AnnotationReference-mtskan,@MetaDataStaticKey>>

== @RequiresEntitlement

Checks to see if a <<AnnotationReference-module,@Module>> or <<AnnotationReference-procan,@Processor>>  requires an Enterprise license with a particular entitlement. Works at connector level. Enterprise only.
...
Checks to see if a <<AnnotationReference-module,@Module>> or <<AnnotationReference-procan,@Processor>>  requires an Enterprise license. The license can be an evaluation license or not. Works at connector level. Enterprise only.
...
Used with the <<AnnotationReference-procan,@Processor>> annotation. Indicates that upon invocation, the processor makes a RESTful request.
...
See also: <<AnnotationReference-binpan,@BinaryParam>>  <<AnnotationReference-confan,@Configurable>> <<AnnotationReference-rstean,@RestExceptionOn>>    <<AnnotationReference-rstpan,@RestHeaderParam>>    <<AnnotationReference-rshcan,@RestHttpClient>>   +
 <<AnnotationReference-rsppan,@RestPostParam>>    <<AnnotationReference-rsqpan,@RestQueryParam>>   <<AnnotationReference-rstoan,@RestTimeout>>   <<AnnotationReference-rsupan,@RestUriParam>>
...
See also: <<AnnotationReference-binpan,@BinaryParam>>  <<AnnotationReference-rstcan,@RestCall>>   <<AnnotationReference-rstpan,@RestHeaderParam>>   <<AnnotationReference-rshcan,@RestHttpClient>>    <<AnnotationReference-rsppan,@RestPostParam>>    +
 <<AnnotationReference-rsqpan,@RestQueryParam>>    <<AnnotationReference-rstoan,@RestTimeout>>    <<AnnotationReference-rsupan,@RestUriParam>>
...
See also: <<AnnotationReference-binpan,@BinaryParam>>  <<AnnotationReference-rstcan,@RestCall>>   <<AnnotationReference-rstean,@RestExceptionOn>>   <<AnnotationReference-rshcan,@RestHttpClient>>   <<AnnotationReference-rsppan,@RestPostParam>>    +
 <<AnnotationReference-rsqpan,@RestQueryParam>>    <<AnnotationReference-rstoan,@RestTimeout>>    <<AnnotationReference-rsupan,@RestUriParam>>
...
See also: <<AnnotationReference-binpan,@BinaryParam>>  <<AnnotationReference-rstcan,@RestCall>>   <<AnnotationReference-rstean,@RestExceptionOn>>    <<AnnotationReference-rstpan,@RestHeaderParam>>    <<AnnotationReference-rsppan,@RestPostParam>>    +
 <<AnnotationReference-rsqpan,@RestQueryParam>>    <<AnnotationReference-rstoan,@RestTimeout>>    <<AnnotationReference-rsupan,@RestUriParam>>
...
See also: <<AnnotationReference-binpan,@BinaryParam>>  <<AnnotationReference-rstcan,@RestCall>>   <<AnnotationReference-rstean,@RestExceptionOn>> <<AnnotationReference-rstpan,@RestHeaderParam>> <<AnnotationReference-rshcan,@RestHttpClient>> <<AnnotationReference-rsqpan,@RestQueryParam>> <<AnnotationReference-rstoan,@RestTimeout>> <<AnnotationReference-rsupan,@RestUriParam>>
...
See also: <<AnnotationReference-binpan,@BinaryParam>>   <<AnnotationReference-rstcan,@RestCall>>   <<AnnotationReference-rstean,@RestExceptionOn>>  <<AnnotationReference-rstpan,@RestHeaderParam>>  <<AnnotationReference-rshcan,@RestHttpClient>>    +
 <<AnnotationReference-rsppan,@RestPostParam>>  <<AnnotationReference-rstoan,@RestTimeout>>    <<AnnotationReference-rsupan,@RestUriParam>>
...
See also: <<AnnotationReference-binpan,@BinaryParam>>   <<AnnotationReference-rstcan,@RestCall>>  <<AnnotationReference-rstean,@RestExceptionOn>>    <<AnnotationReference-rstpan,@RestHeaderParam>>   <<AnnotationReference-rshcan,@RestHttpClient>>    +
 <<AnnotationReference-rsppan,@RestPostParam>>    <<AnnotationReference-rsqpan,@RestQueryParam>>    <<AnnotationReference-rsupan,@RestUriParam>>
...
You can use the <<AnnotationReference-rsupan,@RestUriParam>>  annotation, as well as other related annotations, on  `@Processor`  method arguments or <<AnnotationReference-confan,@Configurable>>  fields of the connector.

When generating the request call, DevKit includes a non-annotated argument and an argument annotated with <<AnnotationReference-payan,@Payload>> as the body of the call.
...
See also: <<AnnotationReference-binpan,@BinaryParam>> <<AnnotationReference-rstcan,@RestCall>>  <<AnnotationReference-rstean,@RestExceptionOn>> <<AnnotationReference-rstpan,@RestHeaderParam>>   +
 <<AnnotationReference-rshcan,@RestHttpClient>> <<AnnotationReference-rsppan,@RestPostParam>>   <<AnnotationReference-rsqpan,@RestQueryParam>>   <<AnnotationReference-rstoan,@RestTimeout>>
...
See also: <<AnnotationReference-inhean,@InboundHeaders>>   <<AnnotationReference-ivhean,@InvocationHeaders>>   <<AnnotationReference-outhan,@OutboundHeaders>>  <<AnnotationReference-payan,@Payload>>
...
See also: <<AnnotationReference-displ,@Dispose>>   <<AnnotationReference-initan,@Initialise>>   <<AnnotationReference-stopan,@Stop>>
...
See also: <<AnnotationReference-displ,@Dispose>>   <<AnnotationReference-initan,@Initialise>>   <<AnnotationReference-stan,@Start>>
...
Marks a method inside a <<AnnotationReference-connan,@Connector>> as a callable from within a Mule flow and capable of generating Mule events.

This annotation marks a method inside a http://mulesoft.github.io/mule-devkit/3.6.2/apidocs/org/mule/api/annotations/Module.html[Module] as callable from within a Mule flow and capable of generating Mule events. Each marked method has an `org.mule.api.source.MessageSource` generated. The method must receive a SourceCallback as one of its arguments. It does not matter which parameter it is as long it is there.
...
See also:  <<AnnotationReference-catan,@Category>>  <<AnnotationReference-confan,@Configurable>>    <<AnnotationReference-connan,@Connector>>    <<AnnotationReference-expran,@Expr>>  <<AnnotationReference-expenan,@ExpressionEnricher>>   +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>  <<AnnotationReference-exlan,@ExpressionLanguage>>  <<AnnotationReference-filan,@Filter>>  <<AnnotationReference-iconan,@Icons>>    <<AnnotationReference-ignan,@Ignore>>  <<AnnotationReference-mimean,@Mime>>   +
 <<AnnotationReference-modulean,@Module>>  <<AnnotationReference-pagean,@Paged>>  <<AnnotationReference-procan,@Processor>>   <<AnnotationReference-tranan,@Transformer>>  <<AnnotationReference-trsan,@TransformerResolver>>
...
Adds display information to a field or parameter. Use this annotation to instance variables and method parameters to provide a way to override the default inferred description for a <<AnnotationReference-confan,@Configurable>> variable or a <<AnnotationReference-procan,@Processor>>, <<AnnotationReference-srcan,@Source>>, <<AnnotationReference-tranan,@Transformer>> method parameter.
...
See also: <<AnnotationReference-fnan,@FriendlyName>>   <<AnnotationReference-passan,@Password>>   <<AnnotationReference-pathan,@Path>>   <<AnnotationReference-plcan,@Placement>>   <<AnnotationReference-textan,@Text>>
...
See also: <<AnnotationReference-configan,@Configuration>> <<AnnotationReference-confan,@Configurable>> <<AnnotationReference-cnctan,@Connect>>
...
See also: <<AnnotationReference-fnan,@FriendlyName>>   <<AnnotationReference-passan,@Password>>   <<AnnotationReference-pathan,@Path>>   <<AnnotationReference-plcan,@Placement>>   <<AnnotationReference-suman,@Summary>>
...
See also:  <<AnnotationReference-catan,@Category>>  <<AnnotationReference-confan,@Configurable>>  <<AnnotationReference-connan,@Connector>>  <<AnnotationReference-expran,@Expr>> <<AnnotationReference-expenan,@ExpressionEnricher>>  +
 <<AnnotationReference-exevan,@ExpressionEvaluator>>  <<AnnotationReference-exlan,@ExpressionLanguage>>  <<AnnotationReference-filan,@Filter>>  <<AnnotationReference-iconan,@Icons>>  <<AnnotationReference-ignan,@Ignore>>   +
 <<AnnotationReference-mimean,@Mime>>  <<AnnotationReference-modulean,@Module>>  <<AnnotationReference-pagean,@Paged>>  <<AnnotationReference-procan,@Processor>>   <<AnnotationReference-srcan,@Source>> <<AnnotationReference-trsan,@TransformerResolver>>
...
See also:  <<AnnotationReference-catan,@Category>>  <<AnnotationReference-confan,@Configurable>>  <<AnnotationReference-connan,@Connector>>  <<AnnotationReference-expran,@Expr>>  <<AnnotationReference-expenan,@ExpressionEnricher>>  <<AnnotationReference-exevan,@ExpressionEvaluator>>  <<AnnotationReference-exlan,@ExpressionLanguage>>  <<AnnotationReference-filan,@Filter>>  <<AnnotationReference-iconan,@Icons>>  <<AnnotationReference-ignan,@Ignore>>  <<AnnotationReference-mimean,@Mime>>    +
 <<AnnotationReference-modulean,@Module>>  <<AnnotationReference-pagean,@Paged>>  <<AnnotationReference-procan,@Processor>>   <<AnnotationReference-srcan,@Source>>  <<AnnotationReference-tranan,@Transformer>>
...
Validates a connection prior to each invocation of the operations exposed by the <<AnnotationReference-procan,@Processor>> annotation.
...
See also:  xref:connection-management.adoc[Connection Management]  <<AnnotationReference-cnctan,@Connect>>  <<AnnotationReference-coidan,@ConnectionIdentifier>>  <<AnnotationReference-discan,@Disconnect>>  <<AnnotationReference-invan,@InvalidateConnectionOn>>  <<AnnotationReference-recan,@ReconnectOn>>