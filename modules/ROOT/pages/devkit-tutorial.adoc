...
:tutorial: Cookbook
:author: MuleSoft Inc.
:page-aliases: creating-a-connector-for-a-restful-api-using-jersey.adoc
...
Before developing a connector you should have a working knowledge of Mule, Anypoint Studio, and Java development in general, specifically the use of https://docs.oracle.com/javase/tutorial/java/annotations/basics.html[Java annotations].
...
+
image::devkit-tutorial-30756.png["A dialog box with options to import existing projects"]
...
+
image::new-connector-1.png["A dropdown menu for creating a new connector project", width="500"]
+
. Select the project type you want to create. In this case, select *SDK Based*:
+
image::new0.png["A dialog box with the SDK Based option selected", width="500"]
+
. Specify the name of your connector and don't forget to uncheck the default generation before clicking *Finish*:
+
image::new1.png["A window for creating a connector project with the default generation unselected"]
+
...
+
image::new-connector-3.png["Screen that shows project with skeleton structure",width="600"]
...
image::enable-view.png["List of views of the connector", width="300"]
...
+
image::config-field.png["Example of configuration for field", width="600"]
+
...
+
image::processor1.png["Example of configuration for processor", width="600"]
+
...
[NOTE]
Connectors built with DevKit 3.9 support specification of examples in a different format. See the new specification and generation format at xref:connector-reference-documentation.adoc[Connector Reference Documentation].
...
image::sample1.png["Screen for how to add a sample", width="600"]
...
+
image::devkit-tutorial-4cb84.png["Configuration window for connector"]
+
. Drag and drop an *Object to JSON* transformer after the connector, and run the app. (Play icon or *Run As* > *Mule Application*)
+
image::devkit-tutorial-1c0f8.png["Example Mule flow for the connector"]
+
[source,xml,linenums]
----
...
image::connection-management.png["Connection configuration window", width="600"]
...
+
image::new-component.png["Dropdown menu to add a new Anypoint Connector Component", width="600"]
+
. Select the package, component type and class name and click on Finish.
+
image::new-component-2.png["Configuration window for adding a new component", width="600"]
+
...
image::reconnect.png["Global elements properties window with the Reconnection tab selected", width="500"]
...
+
image::datasense-expected-ingredients.png["Configuration panel that shows input metadata", width="800"]
+
. Verify that the output metadata is expected:
+
image::datasense-ingredients.png["Configuration panel that shows output metadata", width="800"]
+
...
+
image::datasense-input.png["Transform Message Receiving Connector Output", width="800"]
+
...
+
image::ref-only-input.png["Connector input with RefOnly annotation",width="900"]
+
image::ref-only-output.png["Connector output with Abstract Class",width="900"]
...
+
image::new-metadatacategory.png["Window for creating a new Devkit component for creating a new Metadata Category", width="600"]
+
...
+
image::datasense-static.png["Window with Input tab selected", width="800"]
+
Now even the \{dataWeave} knows how to interact with our @Connector:
+
image::datasense-static2.png["Window with Output tan selected", width="800"]
...
+
image::datasense-ui.png["Input as a map", width="900"]
+
...
+
image::datasense-map.png["Output panel", width="900"]
...
+
image::pagination-component.png["New DevKit component window to add pagination", width="600"]
...
image::pagination-example.png["Example of pagination using the For Each element", width="600"]
...
+
image::install1.png["Dropdown menu to install or update the connector", width="500"]
+
...
+
image::install2.png["Custom connector in the list of connectors to use", width="600"]
...
image::uninstall.png["Uninstalled connector", width="400"]
====
...
+
image::install-updatesite.png["Dropdown menu with the Install New Software option selected", width="600"]
+
...
+
image::install-updatesite2.png["Dialog box for adding software", width="600"]
+
You can either select the zip file named UpdateSite.zip or the folder update-site.
+
image::install-updatesite3.png["Dialog box for adding software with zip file specified", width="600"]
+
A popup will open showing the task that is performed.
[[install-dialog]]
image::install12.png["Installation window for software", width="500"]
+
...
+
image::security-warning.png["Security warning dialog box", width="600"]
+
. You can now use your connector in a Mule app.
+
image::install2.png["Installation window for software", width="600"]
...
. In Anypoint Studio, click *File* > *New* > *Anypoint Connector Project* or right-click your project name in Package Explorer and click *New* > *Anypoint Connector Project*:
+
image::new-connector-1.png["Dropdown menu for creating new Anypoint Connector project", width="500"]
+
. Select the Connector Type you want to create. In this case, select *SDK Based*:
+
image::new0.png["Window for creating new Anypoint Connector project with the SDK based project type", width="500"]
+
. Specify the name of your connector and click *Finish*:
+
image::new-connector-2.png["Window for creating new Anypoint Connector project with the fields specified", width="500"]
+
...
+
image::new-connector-3.png["Window showing skeleton structure of connector", width="600"]
+
. Enable the DevKit view by clicking from the top bar *Window* > *Show view* > *Other*, and look for DevKit in the list.
+
image::enable-view.png["List of views with DevKit view selected", width="300", height="400"]
...
image::split-1-high.png["View structure and UI", width="800"]

In this example, you can check how the code matches to XML and other UI elements.

// TODO: Use 2 images of screenshots with the default layout

image::split-2-high.png["View configuration and XML", width="800"]
...
image::model.png["Layout of connector with multiple configurations"]
////
[plantuml,model,png]
----
...
+
image::source-template.png["Template for configuring a source", width="600"]
...
+
image::source-example.png["Example of flow with Object to JSON and Logger", width="600"]
...
image::source-debug.png["Mule Debugger panel for Logger", width="600"]
...
image::transformer-explicit.png["Mule flow with Transformer", width="600"]
...
image::transformer-implicitly.png["Mule flow with Transformer used implicitly", width="600"]
...
image::password.png["Global Elements Properties window for configuration with password entered", width="500"]
...
For more information, see the https://eclipse-ee4j.github.io/jersey.github.io/documentation/2.11/index.html[Jersey client] documentation.
