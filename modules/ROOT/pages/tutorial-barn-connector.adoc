...
+
image::barnjava.png["Folder structure that shows where the BarnConnector java file is located"]
+
...
+
image::barnimportanno2.png["Barn Connector import placememt"]
+
image::barnimportannotation.png["Barn Connector import friendly name"]
+
...
+
image::barndisablespellchecking.png["Disable spell checking option selected"]
+
...
image::connector-display.png["Barn Connector displayed with friendly name in the list of connectors"]
...
+
image::barnflow.png["Simple flow for Barn Connector"]
+
To configure the Barn connector:
+
.. Click the green plus:
+
image::barnpanel1.png["Panel with arrow pointing to green plus sign"]
+
.. Ensure that the screen appears as follows and click *OK*:
+
image::barnpanel2.png["Global elements properties window for Barn Connector configuration in the General tab"]
+
...
+
image::barnpanel3.png["Panel with the Put in barn operation selected and the Animal field with Mule selected"]
+
...
+
image::barnbrowser.png["Browser with the response of the Mule flow"]
+
