...
image::javadoc-link-sample.png["Example inline link to Javadoc"]
...
image::apidoc-ref-sample.png["Example APIDoc reference link"]
...
image::apidoc-param-sample.png["Example doc that includes parameter name, type, and parameter description"]
...
image::apidoc-look.png["Example of connector operation generated documentation"]
...
image::host-attr.png["Example of attribute table of connector operation doc"]
...
image::multiple-configs.png["List of documentation for multiple configuration types"]
...
image::apidoc-mongo-document-attr.png["Example of attributes table"]
...
image::contextual-help-box.png["Example of contextual help in Studio with links to documentation and other resources"]
