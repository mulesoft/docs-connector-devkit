...
* Readme, use cases, and release notes - See "Documenting with Use Cases" in xref:packaging-your-connector-for-release.adoc[Packaging Your Connector for Release]
