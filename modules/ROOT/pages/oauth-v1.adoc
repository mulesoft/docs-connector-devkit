...
NOTE:
For more information on configuring an *HTTPS connector*, see the xref:3.7@mule-runtime::https-transport-reference.adoc[HTTPS Transport Reference] and xref:http-basic-authentication.adoc[Examples for HTTPS].
